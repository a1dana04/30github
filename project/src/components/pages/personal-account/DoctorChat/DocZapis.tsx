...
import styles from './DocZapis.module.scss';
import doctorAvatar from '@/assets/img/Victorya.png';
        ...
        {appointments.map((appointment) => (
          <div key={appointment.id} className={styles.appointmentCard}>
            ...
            <div className={styles.doctorSection}>
              <div className={styles.doctorName}>{appointment.patient}</div>
            </div>
